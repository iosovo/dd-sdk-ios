...
internal class XCTestsAutoInstrumentation: NSObject, XCTestObservation {
    static var instance: XCTestsAutoInstrumentation?
    ...
    func testBundleDidFinish(_ testBundle: Bundle) {
        ...
        TracingFeature.instance!.storage.writer.queue.sync {} // waits until data is written // swiftlint:disable:this force_unwrapping
    ...
    func testCaseWillStart(_ testCase: XCTestCase) {
        ...
        activeTestSpan = tracer.startSpan(operationName: "XCTest.test", tags: tags)
    }
